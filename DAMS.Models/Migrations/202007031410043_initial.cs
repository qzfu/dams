                ...
                c => new
                    {
                        ...
                        SerialNumber = c.String(maxLength: 50, storeType: "nvarchar"),
                        IsCopyEnd = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        FileName = c.String(maxLength: 600, storeType: "nvarchar"),
                        ...
                        IsCopyEnd = c.Int(nullable: false),
                        DeviceInfo = c.String(unicode: false),
                    })
                ...
                c => new
                    {
                        ...
                        CreatedTime = c.DateTime(nullable: false, precision: 0),
                        ComputerIp = c.String(maxLength: 50, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.Id);
